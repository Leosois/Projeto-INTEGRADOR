    ...
    <div class="container">
        ...
        <div class="conteudo">
            ...
            <div class="titulo">
                ...
                <h2> Intel Core i3 60400F</h2>
                
            </div>

            <div class="img">
                <img class="itemIMG" src="src/img/img9.jpg" alt="">
            </div>
        ...
        <div class="painel">
            ...
            <div class="desc">
                ...
                <div class="preco-parcelado-container">
                    <div class="preco-parcelado">R$ 3.129,24</div>
                    <div class="parcelas-info">
                        em até 12x de <span class="parcela-valor">R$ 260,77</span><br>
                        sem juros no cartão
                    </div>
                </div>
                ...
                <input type="hidden" name="produto_id" value="08">
                <input type="hidden" name="nome" value="Intel Core i3 60400F">
                <input type="hidden" name="preco" value="2559.00">
